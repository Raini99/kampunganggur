 ...
 <div class="row">
     <div class="col-md-12">
         <form action="<?php echo base_url(); ?>/Admin/Kategori/ubah" method="post" enctype="multipart/form-data">
             <input type="hidden" value="<?= $kategori['id_kategori'] ?>" name="id_kategori">
             <div class="card card-footer mx-auto" style="width: 45rem;">
                 <div class="card-header">
                     <h3 class="card-title text-bold">Form Edit Kategori</h3>
                 ...
                 <div class="card-body">
                     <div class="form-group row">
                         ...
                         <div class="col-sm-10">
                             <input type="text" class="form-control" value="<?= $kategori['nama_kategori'] ?>" name="nama_kategori" placeholder="Nama Kategori" required>
                         </div>
                     </div>
                 </div>
