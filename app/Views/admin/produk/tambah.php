 ...
 <div class="row">
     <div class="col-md-12">
         <form action="<?php echo base_url(); ?>/Admin/Produk/simpan" method="post" enctype="multipart/form-data">
             <div class="card card-footer mx-auto" style="width: 45rem;">
                 <div class="card-header">
                     <h3 class="card-title text-bold">Form Tambah Produk</h3>
                 ...
                 <div class="card-body">
                     ...
                     <div class="form-group row">
                         ...
                         <div class="input-group mb-3 col-sm-10">
                             ...
                             <input type="text" value="<?= old('harga') ?>" class="form-control" name="harga" placeholder="Masukkan harga" required>
                         </div>
                     </div>
                     <div class="form-group row">
                     ...
                     <div class="form-group row">
                         ...
                         <div class="col-sm-10">
                             <textarea class="form-control" name="deskripsi" id="exampleFormControlTextarea1" rows="3" value="" placeholder="Enter deskripsi" required><?= old('deskripsi') ?></textarea>
                         </div>
                     </div>
                 </div>
